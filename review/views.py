...
# 이 부분은 detail페이지 구현하는 부분에서 context 만들 때 참고하면 좋을 것 같습니다. (실제 Review앱에서 detail페이지 구현하지않음)
def movie_detail(request, movie_id):
    ...
    context = {
        ...
        'generation_10_rate': (gen_10 / total_user) * 100,
        'generation_20_rate': (gen_20 / total_user) * 100,
        'generation_30_rate': (gen_30 / total_user) * 100,
        'generation_40_rate': (gen_40 / total_user) * 100,        
    }
